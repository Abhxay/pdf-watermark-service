...
> ⚠️ **Note:** This repo is being migrated from Node.js to Java. The source code below reflects the Java version. Push in progress.
>
> ---
>
...
> | Local AWS simulation | **LocalStack** | LocalStack | Same tool. Runs in Docker, simulates AWS S3 locally. No AWS account needed. Same SDK — switching to real AWS later requires zero code changes. |
...
>
> - **Strategy Pattern** — FileProcessingStrategy interface with SmallFileStrategy and LargeFileStrategy. Controller picks based on file size.
...
>
> This command:
> 1. Downloads LocalStack (fake AWS S3) on port 4566
> 2. 2. Compiles the Spring Boot app with Maven inside Docker
>    3. 3. Starts your app on port 8080
>       4. 4. Creates the S3 bucket automatically
>         
>          5. First run takes about 2 minutes (Maven downloads dependencies).
>         
>          6. Wait until you see this in the logs:
>          7. ```
...
> |---|---|---|---|
> | name | string | Yes | Watermark text, max 50 chars |
> | pdf | file | Yes | PDF only, max 100 MB |
>
> **Small file response (200 OK):**
> ```
> Content-Type: application/pdf
> Content-Disposition: attachment; filename="watermarked_yourfile.pdf"
> [PDF bytes — browser downloads directly]
> ```
>
> **Large file response (202 Accepted):**
> ```json
> {
>   "success": true,
